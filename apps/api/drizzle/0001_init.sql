...
CREATE TABLE "meal_plans" (
	"id" serial PRIMARY KEY NOT NULL,
	"meal_plan_id" uuid DEFAULT uuid_generate_v4() NOT NULL,
	"name" varchar(255) NOT NULL,
	"description" text,
	"start_date" date,
	"end_date" date,
...
ALTER TABLE "meal_slots" ADD CONSTRAINT "meal_slots_recipe_id_recipes_id_fk" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_categories_category_id" ON "categories" USING btree ("category_id");--> statement-breakpoint
...
CREATE INDEX "idx_meal_plans_meal_plan_id" ON "meal_plans" USING btree ("meal_plan_id");--> statement-breakpoint
CREATE INDEX "idx_meal_plans_name" ON "meal_plans" USING btree ("name");--> statement-breakpoint
CREATE INDEX "idx_meal_plans_start_date" ON "meal_plans" USING btree ("start_date");--> statement-breakpoint
CREATE INDEX "idx_meal_plans_end_date" ON "meal_plans" USING btree ("end_date");--> statement-breakpoint
CREATE INDEX "idx_meal_slots_meal_plan_id" ON "meal_slots" USING btree ("meal_plan_id");--> statement-breakpoint
CREATE INDEX "idx_meal_slots_recipe_id" ON "meal_slots" USING btree ("recipe_id");--> statement-breakpoint
CREATE INDEX "idx_meal_slots_date" ON "meal_slots" USING btree ("date");--> statement-breakpoint
CREATE INDEX "idx_meal_slots_meal_type" ON "meal_slots" USING btree ("meal_type");--> statement-breakpoint
